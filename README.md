# nvim-treesitter-queries-lalrpop

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-lalrpop/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-lalrpop/actions/workflows/validate.yml)

Neovim tree-sitter queries for **lalrpop**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-lalrpop",
...
- [ ] Changes are scoped to `lalrpop` — do not include files for other languages
